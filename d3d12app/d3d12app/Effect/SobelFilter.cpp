...
void SobelFilter::SetPSODesc(D3D12_GRAPHICS_PIPELINE_STATE_DESC& opaquePsoDesc)
{
...
void SobelFilter::Execute()
{
	...
	mCmdList->SetPipelineState(mSobelPSO.Get());
...
{
	mSobelCS = d3dUtil::CompileShader(L"Shaders\\Sobel.hlsl", nullptr, "SobelCS", "cs_5_1");
}
...
void SobelFilter::BuildPSOs()
{
	...
	ThrowIfFailed(md3dDevice->CreateComputePipelineState(&sobelPSO, IID_PPV_ARGS(&mSobelPSO)));
}